...
public class IncomeTax {
	...
	// Construct a tax object with default (filingStatus, rates, brackets and taxableIncome)
	IncomeTax() {
	...
	// Construct a tax object with specified (filingStatus, rates, brackets and taxableIncome)
